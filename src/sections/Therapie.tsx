          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {consultations.map((c, i) => (
              <button
                ...
                className="group text-left border border-stone-300 dark:border-stone-600 rounded-none hover:border-rust dark:hover:border-stone-300 transition-all duration-300 bg-white/40 dark:bg-white/5 overflow-hidden"
              >
                {c.image && (
